...
import type { FormSectionBaseProps } from '../CustomerAddressForm/types'
...
const CustomerAddressDetails = ({ control, errors }: OverviewSectionProps) => {
    const { id } = useParams()
                                ...
                                <Card>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="heading-text font-bold">{data?.address}</p>
                                        </div>
                                        <div>
