...
const CustomerLicenseReasonTypeListTableFilter = () => {
    const [dialogIsOpen, setIsOpen] = useState(false)

    const { filterData, setFilterData } = useCustomerLicenseReasonTypeList()
...
export default CustomerLicenseReasonTypeListTableFilter
