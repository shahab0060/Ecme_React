...
import type { FormSectionBaseProps } from '../CustomerLicenseReasonTypeForm/types'
...
const CustomerLicenseReasonTypeDetails = ({ control, errors }: OverviewSectionProps) => {
    const { id } = useParams()
...
export default CustomerLicenseReasonTypeDetails
