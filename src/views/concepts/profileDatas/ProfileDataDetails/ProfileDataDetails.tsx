...
import type { FormSectionBaseProps } from '../ProfileDataForm/types'
...
const ProfileDataDetails = ({ control, errors }: OverviewSectionProps) => {
    const { id } = useParams()
                            ...
                            <div className="gap-4 flex flex-col flex-auto">
                                <Card>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <span className="font-semibold">نوع دیتا پروفایل</span>
                                            <p className="heading-text font-bold">{data?.profileDataTypeTitle}</p>
                                        </div>
                                        ...
                                        <div>
                                            <span className="font-semibold">کد گرفتن اطلاعات</span>
                                            <p className="heading-text font-bold">{data?.fetchCode}</p>
                                        </div>
                                        <div>
