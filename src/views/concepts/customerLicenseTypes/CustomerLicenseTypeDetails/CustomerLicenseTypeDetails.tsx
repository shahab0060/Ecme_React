...
import type { FormSectionBaseProps } from '../CustomerLicenseTypeForm/types'
...
const CustomerLicenseTypeDetails = ({ control, errors }: OverviewSectionProps) => {
    const { id } = useParams()
...
export default CustomerLicenseTypeDetails
