...
import type { FormSectionBaseProps } from '../CustomerPhoneForm/types'
...
const CustomerPhoneDetails = ({ control, errors }: OverviewSectionProps) => {
    const { id } = useParams()
                                ...
                                <Card>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="heading-text font-bold">{data?.phone}</p>
                                        </div>
                                        <div>
