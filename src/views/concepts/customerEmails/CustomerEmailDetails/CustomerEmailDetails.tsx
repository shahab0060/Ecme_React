...
import type { FormSectionBaseProps } from '../CustomerEmailForm/types'
...
const CustomerEmailDetails = ({ control, errors }: OverviewSectionProps) => {
    const { id } = useParams()
                                ...
                                <Card>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="heading-text font-bold">{data?.email}</p>
                                        </div>
                                        <div>
