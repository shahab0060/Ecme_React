...
import { apiCreateCustomerEmail } from '@/services/CustomerEmailsService'
...
const CustomerEmailEdit = () => {
    ...
    const handleFormSubmit = async (values: CustomerEmailFormSchema) => {
        setIsSubmiting(true)
        try {
            const response = apiCreateCustomerEmail(values);
            setIsSubmiting(false)

            if ((await response).status === 200) {
                toast.push(
                    <Notification type="success">ایمیل مشتری ایجاد شد!</Notification>,
    ...
    const handleConfirmDiscard = () => {
        ...
        toast.push(
            <Notification type="success">ایمیل مشتری کنار گذاشته شد!</Notification>,
            { placement: 'top-center' },
        )
        navigate('/concepts/customerEmails/customerEmail-list')
    }
