...
import { apiUpdateCustomerUser } from '@/services/CustomerUsersService'
...
const CustomerUserEdit = () => {
    ...
    const handleFormSubmit = async (values: CustomerUserFormSchema) => {
        setIsSubmiting(true)
        try {
            const response = apiUpdateCustomerUser(values);
            setIsSubmiting(false)

            if ((await response).status === 200) {
                toast.push(
                    <Notification type="success">کاربر مشتری ویرایش شد!</Notification>,
    ...
    return (
        <>
            ...
            {!isLoading && data && (
                <>
                    <CustomerUserForm
                        defaultValues={getDefaultValues() as CustomerUserFormSchema}
                    ...
                    >
                        <p>
                            آیا مطمئنید که می خواهید این کاربر مشتری را حذف کنید؟ این
