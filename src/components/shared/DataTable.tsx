...
export type OnSortParam = { order: 'ascending' | 'descending' | ''; key: string | number }
...
function _DataTable<T>(
    ...
    const { takeEntity, pageId, total } = pagingData
                ...
                <div style={{ minWidth: 130 }}>
                    <Select
                        ...
                        value={pageSizeOption.filter(
                            (option) => option.value === takeEntity,
                        )}
